...
const LoginScreen = () => {
  ...
  const [, setDataProfileState] = useRecoilState(ProfileState)
  ...
  const onLoginGoogle = async () => {
    try {
      ...
      navigation.navigate('BottomMenu', { user: userCredential.user })

      setLoading(false)
    } catch (error) {
      console.error('Error during Google login:', error)
      setLoading(false)
      Alert.alert('Failed to log in with Google. Please try again.')
    }
  }
